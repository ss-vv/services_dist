...
// 客服打卡
Route::post('punch_cards', 'Api\PunchCardController@store')->name('punch_cards.store');
// 客服某段时间内最后一次打卡记录
...
// 出款客服打卡
Route::post('withdrawal-punch-cards', 'Api\WithdrawalController@store')->name('withdrawal.punch-cards');
// 查询提现申请记录
